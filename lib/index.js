...
var Scheduler = (_temp = _class = function (_Component) {
            ...
            var radioButtonList = config.views.map(function (item) {
                ...
                return _react2.default.createElement(
                    ...
                    { key: '' + item.viewType + (item.showAgenda ? 1 : 0) + (item.isEventPerspective ? 1 : 0),
                        value: '' + item.viewType + (item.showAgenda ? 1 : 0) + (item.isEventPerspective ? 1 : 0), type: 'radio' },
                ...
                schedulerHeader = _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(_ai.AiFillCaretLeft, { style: { marginRight: "8px" }, className: 'icon-nav',
                                onClick: this.goBack }),
                            _react2.default.createElement(
                                'span',
                            ...
                            _react2.default.createElement(_ai.AiFillCaretRight, { style: { marginLeft: "8px" }, className: 'icon-nav',
                                onClick: this.goNext })
                        )
                    ),
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            { value: defaultValue, size: 'sm', name: 'views', onChange: this.onViewChange },
                            radioButtonList
                        )
                    ),
                    rightCustomHeader
    ...
    this.onViewChange = function (value) {
